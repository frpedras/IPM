...
public class ConfigurationsPsi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_configurations_psi);
    ...
    public void save(View v){
        if (v.getId() == R.id.Bsave){
            Intent i = new Intent(ConfigurationsPsi.this, MenuPrincipal.class);
            startActivity(i);
        }
    }
    ...
    public void selectFood(View v){
        if (v.getId() == R.id.Bselectfood){
            Intent i = new Intent(ConfigurationsPsi.this, SelectFood.class);
            startActivity(i);
        }
    }
    ...
    public void selectAlerts(View v){
        if (v.getId() == R.id.Balerts){
            Intent i = new Intent(ConfigurationsPsi.this, Alerts.class);
            startActivity(i);
        }
    }


    public void selectParam(View v){
        if (v.getId() == R.id.Bparam){
            Intent i = new Intent(ConfigurationsPsi.this, ParamFood.class);
            startActivity(i);
        }
    }

    public void selectParamlvl(View v){
        if (v.getId() == R.id.Bparamlevel){
            Intent i = new Intent(ConfigurationsPsi.this, ParamLevel.class);
            startActivity(i);
        }
    }
